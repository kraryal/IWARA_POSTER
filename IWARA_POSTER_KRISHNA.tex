...
{
\centerline{
{\includegraphics[scale=1.6]{figures/2hifs1.pdf}}	
}}}
\vspace{.8cm}
...
\centerline{
	\includegraphics[width=0.82\linewidth]{figures/fig_15_higher_temp1.pdf}}
	\vspace{2cm}
\centerline{
	\includegraphics[width=0.82\linewidth]{figures/fig_37_higher_temp1.pdf}}
...
\vspace{3.1cm}
\center{
\includegraphics[scale=1]{logos/12345.png}}
\vspace{2mm}
}
